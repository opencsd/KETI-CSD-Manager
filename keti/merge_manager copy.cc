...
void MergeManager::MergeBlock(Result &result){
    ...
    //현재 40k 블록 데이터가 모두 필터되었다면
    if(result.row_count != 0){
        // cout << "all filtered" << endl;
        ...
        //     exit(0);
        // }
    //     m_MergeManager[key].merged_block_id_list.push_back(result.block_id_list);
    // }
