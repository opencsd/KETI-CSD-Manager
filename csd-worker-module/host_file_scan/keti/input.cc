...
void Input::InputSnippet(){
	...
	// 	//로그
	// 	printf("[CSD Input Interface] CSD Worker Module receive the snippet <%d-%d>\n",parsedSnippet.query_id,parsedSnippet.work_id);
	// 	// char log_char[100];
	// 	// sprintf(log_char, "CSD Worker Module receive the snippet (%d:%d)",parsedSnippet.query_id,parsedSnippet.work_id);
